...
def run_gemini_agent(execute: bool = False, model: str = "gemini-flash-lite-latest"):
    ...
    system_prompt = (
        ...
        "8. ALINEACIÓN COMPETITIVA & FLEXIBILIDAD TÁCTICA (NO LIMITARSE A 3-4-3):\n"
        "   - La alineación NUNCA debe encasillarse por defecto en un 3-4-3; hay muchas distribuciones válidas (3-4-3, 3-5-2, 4-3-3, 4-4-2, 4-5-1, 5-3-2, 5-4-1...).\n"
        "   - El sistema debe elegir la formación óptima según el número de efectivos disponibles en cada línea y la calidad/forma de los jugadores, priorizando a los mejores futbolistas para maximizar los puntos del 11.\n"
